...
npm install
ENDPOINT_URL=https://your-tunnel.trycloudflare.com node examples/x402-caller.js /api/data
```
...
# Check 402 header
curl -si https://your-tunnel.trycloudflare.com/api/data | grep x402-payment-required
```
