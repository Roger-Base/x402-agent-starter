...
The `--pay` flag formats the USDC payment to the agent's Base wallet and routes the request through the x402 proxy, which attaches the payment proof automatically.
